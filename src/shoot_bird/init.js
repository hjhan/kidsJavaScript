...
function queueLoaded(event) {
    ...
    //Add Score
    scoreText = new createjs.Text("分数: " + score.toString(), "36px Arial", "#FFF");
    scoreText.x = 10;
    scoreText.y = 10;
    stage.addChild(scoreText);

    //Ad Timer
    timerText = new createjs.Text("时间: " + gameTime.toString(), "36px Arial", "#FFF");
    timerText.x = 800;
    timerText.y = 10;
...
function handleMouseDown(event) {
    ...
    if (distX < 30 && distY < 59) {
        ...
        //Create new enemy
        var timeToCreate = Math.floor((Math.random() * 1500) + 1);
